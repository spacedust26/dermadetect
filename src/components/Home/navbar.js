...
export default function Navbar() {
  return (
    <header className="flex h-15 w-full shrink-0 items-center px-4 md:px-6">
      <Sheet>
        ...
        <SheetContent side="left">
          ...
          <div className="grid gap-2 py-6">
            ...
            <Link href="#service" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              Services
            </Link>
      ...
      <div className="flex flex-row items-center justify-center gap-1">
        ...
        <div className="m-3"><ModeToggle /></div>
      </div>
